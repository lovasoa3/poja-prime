package com.nantenaina.base.endpoint.event;
...
import com.nantenaina.base.repository.DummyUuidRepository;
        ...
        List.of(
            new EventConsumer.AcknowledgeableTypedEvent(
                new EventConsumer.TypedEvent(
                    "com.nantenaina.base.endpoint.event.gen.UuidCreated", payloadReceived),
                () -> {})));
